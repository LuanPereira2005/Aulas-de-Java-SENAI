...
public class VendaTop {
	...
	public static void main(String[] args) {
		// Criacao de variaveis e atribuicao de valor a um deles
		int prod1;
		int prod2;
		double desc;
		double total;
		...
		// Usando o scanner para atribuir valores as variaveis
		...
		// Teste condicional if para mostrar os valores e somar o total e se caso nao
		// existir o numero escolhido mostrar na tela que nao existe
		if ((prod1 == 1) && (prod2 == 1)) {
